...
const reasoning = () => {
    ...
    const [examTaken, setExamTaken] = React.useState(localStorage.getItem('examTakenReasoning'));
    ...
    const handleSubmit = async () => {
        ...
        localStorage.setItem('examTakenReasoning', true);
        setExamTaken(true);
    ...
    <>
        <Box m="50px">
            <Header title="REASONING TEST" subtitle="Please answer the following question:" />
